...
OnOffApplication::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::OnOffApplication")
    ...
    .AddAttribute ("DstSinkTeam", "The team of destination sinks",
                         UintegerValue (0),
                         MakeUintegerAccessor (&OnOffApplication::m_dstsinkteam),
...
void OnOffApplication::SendPacket ()
{
  ...
  Tdstteam.SetDestTeam(m_dstsinkteam);
  Ptr<Packet> packet = Create<Packet> (m_pktSize);
  packet->AddPacketTag(Tdstteam);
  m_txTrace (packet);
