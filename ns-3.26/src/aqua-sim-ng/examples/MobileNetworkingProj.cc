...
main (int argc, char *argv[])
{
	...
	asHelper.SetPhy ("ns3::AquaSimPhyCmn",
		// Important!! I have changed it, if range propagation model, PT is Sound Intensity
		"PT", DoubleValue (176), //Tx Sound Power Level Lw, Lw = 10lg(W/W_0), W is Power(W), W_0 = 1pW; 130dB means 10W
		"Frequency", DoubleValue (25), /* kHz */
		"RXThresh", DoubleValue (0), /* W, Receive signal power threshold*/
		"PerOn", UintegerValue(0)
		);
	...
	*/
	...
	// sinksCon.Get(0)->GetId() == 200
	// std::cout << "sink node id(start from 0)=" << sinksCon.Get (0)->GetId () << std::endl;
	std::ostringstream ossSensor0Tx, ossSensor1Tx, ossAuv0Tx, ossAuv1Tx, ossSysTx;
	ossSensor0Tx << "/NodeList/" << sensorsCon.Get(0)->GetId() << "/DeviceList/*/$ns3::AquaSimNetDevice/Mac/MacTx";
	Config::ConnectWithoutContext (ossSensor0Tx.str(), MakeCallback(&MacRxFromUpperSensor0));
	ossSensor1Tx << "/NodeList/" << sensorsCon.Get(1)->GetId() << "/DeviceList/*/$ns3::AquaSimNetDevice/Mac/MacTx";
	Config::ConnectWithoutContext (ossSensor1Tx.str(), MakeCallback(&MacRxFromUpperSensor1));
	ossAuv0Tx << "/NodeList/" << auvsSingleCon.Get(0)->GetId() << "/DeviceList/*/$ns3::AquaSimNetDevice/Mac/MacTx";
	Config::ConnectWithoutContext (ossAuv0Tx.str(), MakeCallback(&MacRxFromUpperAuv0));
	ossAuv1Tx << "/NodeList/" << auvsSingleCon.Get(1)->GetId() << "/DeviceList/*/$ns3::AquaSimNetDevice/Mac/MacTx";
	Config::ConnectWithoutContext (ossAuv1Tx.str(), MakeCallback(&MacRxFromUpperAuv1));


//	Config::ConnectWithoutContext ("/NodeList/*/DeviceList/*/$ns3::AquaSimNetDevice/Mac/MacTx", MakeCallback(&MacRxFromUpper));



	ossSysTx << "/NodeList/*/DeviceList/*/$ns3::AquaSimNetDevice/Mac/MacTx";
	Config::ConnectWithoutContext (ossSysTx.str (), MakeCallback (&MacRxFromUpper));

	std::ostringstream ossSink0Recv, ossSink1Recv, ossSink2Recv, ossSysRecv;


	ossSink0Recv << "/NodeList/" << glidersCon.Get (0)->GetId () << "/DeviceList/*/$ns3::AquaSimNetDevice/Mac/RoutingRx";
	Config::ConnectWithoutContext (ossSink0Recv.str (), MakeCallback (&MacRxFromLowerSink0));
	ossSink1Recv << "/NodeList/" << glidersCon.Get (1)->GetId () << "/DeviceList/*/$ns3::AquaSimNetDevice/Mac/RoutingRx";
	Config::ConnectWithoutContext (ossSink1Recv.str (), MakeCallback (&MacRxFromLowerSink1));
	ossSink2Recv << "/NodeList/" << glidersCon.Get (2)->GetId () << "/DeviceList/*/$ns3::AquaSimNetDevice/Mac/RoutingRx";
	Config::ConnectWithoutContext (ossSink2Recv.str (), MakeCallback (&MacRxFromLowerSink2));

	ossSysRecv << "/NodeList/*/DeviceList/*/$ns3::AquaSimNetDevice/Mac/RoutingRx";
	Config::ConnectWithoutContext (ossSysRecv.str (), MakeCallback (&MacRxFromLowerSys));

	std::string asciiTraceFile = "MVBFMobile-trace.asc";
