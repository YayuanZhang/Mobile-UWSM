...
public:
  ...
  void SetSinkTeam(uint16_t sinkTeam=0);
  uint16_t GetSinkTeam();
  ...
  //DBR
   std::map<int, std::pair<int, double> >  m_SentPktRecord;
   std::map<int, std::pair<int, double> > SentPktRecord(){return m_SentPktRecord;}
