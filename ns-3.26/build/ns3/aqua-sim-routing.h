...
/*define common commands for underwater routing protocols*/
  ...
  std::set<int> SendUpPktsetMerg() {return m_sendupPktRecord;}
  ...
  //DBR
   std::map<int, std::pair<int, double> >  m_sendUpPktsRecord;
   std::map<int, std::pair<int, double> > SendUpPktRecord(){return m_sendUpPktsRecord;}
